...
import { SET_LABOUR_DETAILS } from '../actions/types';
...
const LabourDetails = () => {
    ...
    const [workData, setworkData] = useState(["Land plowing", "Land plowing with tractor", "Weed removing",
        "Pesticide spraying", "Hand harvesting", "Crop spanking", "Pumpset duty", "Land cleaning", "Tree climbing",
        "Paddy Steaming"]);
    const keyvalues = ["landPlowing", "landPlowingWithTractor", "weedRemoving", "pesticideSpraying", "handHarvesting", "cropSpanking", "pumpsetDuty", "landCleaning", "treeClimbing", "paddySteaming"]
    const worksdata = {
        landPlowing: false,
    ...
    const handleSubmit = (e) => {
        ...
        axiosInstance.post('/application/labours', postData)
            ...
            }).catch(err => console.log("LabourDetails", err))
            ...
            <Container component="main" maxWidth="sm">
                ...
                >
                    {Error && <Alert severity="warning">
                        ...
                        You have Already added this Work — <strong>Please try to different One!</strong>
                    </Alert>}
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} >
                                <FormControl fullWidth style={{ minWidth: '180px' }} >
                                    ...
                                    >
                                        {workData.map((Value, index) => <MenuItem value={keyvalues[index]}>{Value}</MenuItem>)}
