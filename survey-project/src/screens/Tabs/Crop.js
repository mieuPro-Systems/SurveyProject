...
const Crop = (props) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        let CropDetailData = CropsDetail;
        CropDetailData.forEach((data) => {
            delete data.sno
        })
        console.log("Crops Details", CropDetailData);
        dispatch({
            type: SET_CROP_DETAILS,
            payload: CropDetailData
        })
        console.log("farmersredux", farmers)
        const postData = {
            farmerDetails: farmers.farmerDetails,
            cropDetails: CropDetailData
        }
