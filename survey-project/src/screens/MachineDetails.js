                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={4}>
                                <div style={{ flexDirection: 'row', display: 'flex', justifyContent: 'center', marginTop: '14px' }}>
                                    <p style={{ marginTop: '1px', marginRight: '7px', fontSize: '20px' }}>Total Machines :</p>
                        ...
                        <Table sx={{ minWidth: 700 }} aria-label="customized table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell align="center">Rental Basis</StyledTableCell>
                                ...
                                {Machines.length > 0 &&
                                    Machines.map((machine, index) => (
                                        <StyledTableRow key={index + 1}>
                                            ...
                                            <StyledTableCell align="center">{machine.rentalBasis}</StyledTableCell>
                                            <StyledTableCell align="center">{machine.rent}</StyledTableCell>
                                            <StyledTableCell align="left" onClick={() => { setMachines(prevValues => prevValues.filter((value, prevIndex) => prevIndex !== index)) }}>
                                                {<HighlightOffIcon style={{ cursor: 'pointer' }} />}</StyledTableCell>
                                        </StyledTableRow>
                                    ))}
                            </TableBody>
                        </Table>
                        {Machines.length === 0 && <p style={{ textAlign: 'center' }}>No records  Added</p>}
                    </TableContainer>
                </div>
